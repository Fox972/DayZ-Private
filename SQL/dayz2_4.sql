...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insUNselI`(in myuid varchar(128), in myname varchar(255))
begin
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `selIIBSM`(in myuid varchar(128))
begin
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `selIPIBMSSS`(in myuid varchar(128))
begin
