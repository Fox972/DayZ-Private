...
"Expansion\beta\arma2oaserver.exe" -port=2302 "-config=Sanctuary\config_lingor.cfg" "-cfg=Sanctuary\basic.cfg" "-profiles=Sanctuary" -name=Sanctuary "-mod=@Arma2NET;@CBA;@CBA_OA;@CBA_A2;@DayZ_lingor;@dayz_lingor_island;@Sanctuary_Lingor;" -cpuCount=4 -maxMem=1578 -exThreads=7
