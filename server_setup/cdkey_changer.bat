...
if "%lang%"=="1" (
	...
	echo and copy here the BOTTOM SERIALS WITHOUT SPACES!
	echo.
	goto custom_serial
)
goto inicio
...
echo.
if "%lang%"=="1" (
	SET /P arma2key=Type 30 digits to enter ArmA 2 serial number: 
	SET /P arma2OAkey=Type 30 digits to enter OA serial number: 
) else (
