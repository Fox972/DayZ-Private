...
player_discoMorph = 		compile preprocessFileLineNumbers "\z\addons\dayz_server\compile\player_discoMorph.sqf";				//Lingor_dev Add these lines to the other compiles
disco_handler = 			compile preprocessFileLineNumbers "\z\addons\dayz_server\compile\disco_functions_med.sqf";				//Lingor_dev Add these lines to the other compiles
...
server_updateNearbyObjects =    compile preprocessFileLineNumbers "\z\addons\dayz_server\compile\server_updateNearbyObjects.sqf";	//Sanctuary Add these lines to the other compiles
...
dayz_recordLogin = {
	private["_key"];
	_key = format["CHILD:103:%1:",_this select 0];
